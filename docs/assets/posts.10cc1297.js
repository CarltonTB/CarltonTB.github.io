import"./modulepreload-polyfill.c7c6310f.js";async function i(){try{const n=await(await fetch("/blog/posts-manifest.json")).json(),o=document.getElementById("posts-list");if(n.length===0){o.innerHTML="<p>No posts yet.</p>";return}const s=n.map(t=>`
